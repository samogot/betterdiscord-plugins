...
@else @*/
	...
	/***/ (function(module, exports) {
		...
		module.exports = {"info":{"name":"Quoter","authors":["Samogot"],"version":"3.6.2","description":"Add citation using embeds","repository":"https://github.com/samogot/betterdiscord-plugins.git","homepage":"https://github.com/samogot/betterdiscord-plugins/tree/master/v2/Quoter","reloadable":true},"defaultSettings":[{"id":"embeds","type":"bool","text":"Use embeds for quoting","description":"Use embeds if possible and fallback to markdown-formated quotes otherwise. Uncheck if you want to always use fallback mode","value":true},{"id":"noEmbedsServers","type":"text","multiline":false,"text":"Don't use embeds on this servers","description":"Some servers disallow self-botting. Despite this plugin isn't a bot, it's hard to approve it. So if on some server users not allowed to use embeds, you can add that server ID to this space separated black list. To get server id see this instructions: https://goo.gl/w77phg","value":""},{"id":"utc","type":"bool","text":"Use UTC TimeZone","description":"Use UTC TimeZone to display time in fallback mode","value":false},{"id":"24h","type":"bool","text":"Use 24h format","description":"Use 24h format to display time in fallback mode","value":true},{"id":"mention","type":"bool","text":"Mention cited users","description":"Automatically add mention of users, whose messages are cited","value":false},{"id":"citeFull","type":"bool","text":"Cite full message group","description":"Clicking on quote icon cause citing full message group instead of one message. Use Alt+Click to quote single message.","value":true}],"permissions":[]}
